...
# 06. CU 웹 이동
choose = dr.find_element(By.XPATH, '//*[@id="navbarSupportedContent"]/ul/li[2]/a')
choose.send_keys('\n')
time.sleep(2)
...
while True:
    try:
        ...
        f.write(str(image_full_count) + '-CU-' + product_type + '-' + product_name + '-' + product_price + '\n')
        ...
        if image_count == 21:
            ...
            next_url = 'https://pyony.com/brands/cu/?page=' + str(page_count)
            dr.get(next_url)
